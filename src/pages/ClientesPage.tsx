...
const ClientesPage: React.FC = () => {
  ...
  // filteredCustomers will be derived by useMemo
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const sortedCustomers = customersData.sort((a,b) => new Date(b.lastPurchaseDate || 0).getTime() - new Date(a.lastPurchaseDate || 0).getTime());
